...
#' 
#' # Eigen decomposition
#' e.cov <- eigen(hat.cov.m)
#' 
#' # pvalue
#' pval <- get_pval_Ec(x=hat.mu, x0=mu0, N=N, eigen=e.cov)
#' pval
#' @export
...
#' 
#' # pvalue
#' pval <- get_pvalue_FFSCB_t(x=hat.mu, x0=mu0, tau=hat.tau.v, diag.com=diag(hat.cov.m), N=N, 
#' n.eval.points=6)
