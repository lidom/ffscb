...
#layout.show(6)
par(family = "serif", ps=13, cex.main=1, cex.axis=1.3, font.main = 1, mar=mar_u1)
...
legend(x = 0, y=yliml[1]*0.5, legend = c(expression(B[Ec]), "FF-t", "KR-t"), 
       lty=c(3,1,5), bty="n", lwd = c(1), col=c("black"), cex = 1.5)
legend(x = 0.55, y=yliml[1]*0.5, legend = c("Bootstrap", "naive-t"), pch=22, bty="n",
